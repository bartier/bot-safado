...
if __name__ == "__main__":
    ...
    parser.add_argument('--entrada', type=str, required=True, default='palavras.txt', help='Arquivo de entrada contendo as palavras')
    parser.add_argument('--saida', type=str, required=True, default='palavras_sem_verbos.txt', help='Arquivo de saída contendo as palavras sem verbos')
